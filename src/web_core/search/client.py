...
def _process_search_results(results: list[dict[str, Any]], max_results: int) -> list[SearchResult]:
    """Deduplicate results, select longest snippets, apply domain cap, and convert to SearchResult objects."""
    seen: dict[str, dict[str, Any]] = {}
    url_to_norm: dict[str, str] = {}  # Local cache to eliminate redundant normalization
