...
class TLSSpoofStrategy(BaseStrategy):
    ...
    async def fetch(self, url: str, selectors: dict[str, str] | None = None) -> ScrapingResult:
        ...
        if self._session_factory is not None:
            ...
            response = await self._do_fetch_with_redirects(session, url, cookies)
        else:
    ...
    async def _do_fetch_with_redirects(self, session: Any, url: str, cookies: dict[str, str] | None) -> Any:
    ...
    def _create_result(self, response: Any) -> ScrapingResult:
