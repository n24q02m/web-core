...
# Performance Optimization: Combining tag stripping patterns into a single pass
# prevents intermediate string allocations and redundant work.
...
def visible_text(html: str) -> str:
    ...
    if not html:
        return ""
    stripped = _HTML_STRIP_RE.sub(" ", html)
