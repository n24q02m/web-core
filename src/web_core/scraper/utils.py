...
def visible_text(html: str) -> str:
    ...
    # Performance Optimization: Combining multiple regex substitutions (script, style, tag)
    # into a single alternated regex reduces string allocations and regex engine passes.
