...
class TestScrapingAgent:
    ...
    async def test_scrape_returns_content(self):
        ...
        agent = ScrapingAgent(
            ...
            config=ScraperConfig(min_content_length=50),
        )
    ...
    async def test_scrape_escalates_on_short_content(self):
        ...
        agent = ScrapingAgent(
            ...
            config=ScraperConfig(min_content_length=100),
        )
    ...
    async def test_scrape_with_selector_inference_flow(self):
        ...
        agent = ScrapingAgent(
            strategies={"basic": strategy},
            config=ScraperConfig(min_content_length=100, enable_selector_inference=True),
        )
