...
class TestScrapingAgent:
    ...
    async def test_scrape_returns_content(self):
        ...
        agent = ScrapingAgent(strategies={"basic": strategy}, config=AgentConfig(min_content_length=50))
    ...
    async def test_scrape_escalates_on_short_content(self):
        ...
        agent = ScrapingAgent(
            ...
            config=AgentConfig(min_content_length=100),
        )
    ...
    async def test_scrape_escalates_on_error_status(self):
        ...
        agent = ScrapingAgent(
            ...
            config=AgentConfig(min_content_length=50),
        )
    ...
    async def test_max_retries_limits_attempts(self):
        ...
        agent = ScrapingAgent(strategies=strategies, config=AgentConfig(max_retries=3))
    ...
    async def test_custom_min_content_length(self):
        agent = ScrapingAgent(config=AgentConfig(min_content_length=50))
    ...
    async def test_validate_accepts_3xx_status(self):
        ...
        agent = ScrapingAgent(strategies={"redirect": strategy}, config=AgentConfig(min_content_length=50))
    ...
    async def test_scrape_with_selector_inference_flow(self):
        ...
        agent = ScrapingAgent(
            ...
            config=AgentConfig(min_content_length=100, enable_selector_inference=True),
        )
