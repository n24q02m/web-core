...
def test_write_secure_text_creates_file(tmp_path: Path):
...
def test_write_secure_text_overwrites_file(tmp_path: Path):
...
def test_write_secure_text_handles_utf8(tmp_path: Path):
